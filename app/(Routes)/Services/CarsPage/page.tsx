...
<div className='bg-black hidden sm:block shadow-inner shadow-gray-500 bg-opacity-20'>
  ...
  {showOffer && (
        <div className="fixed top-5 left-1/2 transform -translate-x-1/2 z-50 bg-red-600 text-white sm:px-6 sm:py-3 mt-10 rounded-md sm:mt-32 shadow-lg">
          <p className="text-lg font-bold">Limited Time Offer! Honda Civic at pkr 26lac (Save pkr 2lac!)</p>
        </div>
      )}
  <h3
  className='sm:p-9 sm:mb-72 sm:mt-52 sm:text-red-700 mb-10 text-sm text-white sm:text-4xl flex justify-center cursor-default items-center bg-opacity-10 bg-black transition duration-500 ease-in-out hover:text-white'
>
  -----------------Explore Our Latest Car Models---------------
</h3>
