...
const OurImport = () => {
  return (
    ...
    <div className="max-w-4xl mx-auto p-4 bg shadow-lg rounded-lg">
      ...
      <p className="text-lg mb-4">
        The vehicles we import from Japan are thoroughly inspected and reconditioned to meet the highest standards. This ensures that our customers receive vehicles that are not only durable but also efficient and stylish. Whether you&apos;sre looking for a luxurious car, a reliable bike, or a sturdy bus, we have you covered.
      </p>
